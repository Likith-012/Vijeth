  ...
  const [rejectedProjects, setRejectedProjects] = useState<RejectedProject[]>([
    {
      ...
      editor: "Jamie Rivera",
      imageCount: 120,
      rejectedDate: "2025-05-18",
      client: "Fashion Brand X",
      reviewedBy: "Taylor Morgan",
      reason: "Inconsistent lighting and white balance across the set. Color grading doesn't match brand guidelines."
    },
    {
      id: "2",
      projectName: "Outdoor Adventures Campaign",
      editor: "Alex Thompson",
      imageCount: 45,
      rejectedDate: "2025-05-15",
      client: "Adventure Gear Co.",
      reviewedBy: "Jordan Chen",
      reason: "Heavy-handed retouching on landscape elements. Client requested a more natural look."
    }
  ]);
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="flex text-sm">
                  ...
                  <span>Rejected on {new Date(project.rejectedDate).toLocaleDateString()}</span>
                </div>
